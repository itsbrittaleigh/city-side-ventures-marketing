...
const pressPostPhoto = require('../assets/images/covers/news/press.jpg');
const savePostPhoto = require('../assets/images/covers/news/save.jpeg');
const weatherPostPhoto = require('../assets/images/covers/news/weather.png');
